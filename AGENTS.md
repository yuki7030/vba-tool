...
- 仕様は2層(正本=docs/spec/features/ 、変更要求=docs/spec/changes/)。新機能・仕様変更は承認済み変更要求が前提。無ければ spec-writing で起案し承認を得る。draft/ 配下は未承認、着手禁止。
...
- 仕様(docs/spec/features/ の正本)と既存挙動が矛盾する場合は仕様を正とする。
